...
const AdminDashboard = () => {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, student_name: "Aman Sharma", field_name: "Phone Number", requested_value: "9876543210" },
    { id: 2, student_name: "Priya Verma", field_name: "Address", requested_value: "Morar, Gwalior" }
  ]);
...
const headerTag = { fontSize: '24px', fontWeight: '800', opacity: 0.9, letterSpacing: '1px', whiteSpace: 'nowrap' };
const vDivider = { width: '1px', height: '20px', background: 'rgba(255,255,255,0.3)' };
const headerNav = { display: 'flex', gap: '20px', flexWrap: 'wrap' };
const headerLink = { color: '#fff', textDecoration: 'none', fontSize: '15px', fontWeight: '600' };
...
const hStatCard = { background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(100px)', padding: '10px 20px', borderRadius: '12px', display: 'flex', flexDirection: 'column' };
...
const tickerText = { display: 'inline-block', animation: 'marquee 25s linear infinite', color: '#8cde19a4', fontSize: '20px', margin: 0, paddingLeft: '100%', lineHeight: '36px' };
